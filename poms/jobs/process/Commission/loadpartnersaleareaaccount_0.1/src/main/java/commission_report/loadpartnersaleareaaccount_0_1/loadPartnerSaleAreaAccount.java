...
public class loadPartnerSaleAreaAccount implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				strReturn = new String(commonByteArray_COMMISSION_REPORT_loadPartnerSaleAreaAccount, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:B22gIa3D5W1c0Sums2Rrte9vPtbbw6I1rY4VYrCrJTah1pWr");
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
								+ "(RELA_ID INT  not null ,SUBSCR_NO VARCHAR(30)   not null ,SAA_CODE VARCHAR(30)  ,COMMISSION_START_DATE DATE ,COMMISSION_END_DATE DATE ,primary key(RELA_ID))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM " + tableName_tDBOutput_1 + " WHERE RELA_ID = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (RELA_ID,SUBSCR_NO,SAA_CODE,COMMISSION_START_DATE,COMMISSION_END_DATE) VALUES (?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE " + tableName_tDBOutput_1
						+ " SET SUBSCR_NO = ?,SAA_CODE = ?,COMMISSION_START_DATE = ?,COMMISSION_END_DATE = ? WHERE RELA_ID = ?";
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:hXzXKTpAUYoRqW4TrlyQQHdeDs7w3cBcB6DLh7jtbms2pi95JtvEfElE");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						pstmt_tDBOutput_1.setInt(1, row1.RELA_ID);
						...
						if (checkCount_tDBOutput_1 > 0) {
							...
							pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, row1.RELA_ID);
							...
							pstmtInsert_tDBOutput_1.setInt(1, row1.RELA_ID);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = loadPartnerSaleAreaAccount.class.getClassLoader().getResourceAsStream(
					"commission_report/loadpartnersaleareaaccount_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = loadPartnerSaleAreaAccount.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : loadPartnerSaleAreaAccount");
		}
...
/************************************************************************************************
 * 57713 characters generated by Talend Open Studio for Data Integration on the
 * March 29, 2021 6:19:19 PM ICT
 ************************************************************************************************/