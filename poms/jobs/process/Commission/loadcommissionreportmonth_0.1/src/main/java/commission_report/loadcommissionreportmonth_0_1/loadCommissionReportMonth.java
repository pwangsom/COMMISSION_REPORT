...
package commission_report.loadcommissionreportmonth_0_1;
...
/**
 * Job: loadCommissionReportMonth Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status PROD
 */
public class loadCommissionReportMonth implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "loadCommissionReportMonth";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				loadCommissionReportMonth.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(loadCommissionReportMonth.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_COMMISSION_REPORT_loadCommissionReportMonth = new byte[0];
    static byte[] commonByteArray_COMMISSION_REPORT_loadCommissionReportMonth = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.REPORT_MONTH_ID == null) ? 0 : this.REPORT_MONTH_ID.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						if (this.REPORT_MONTH_ID == null) {
							if (other.REPORT_MONTH_ID != null)
								return false;
						
						} else if (!this.REPORT_MONTH_ID.equals(other.REPORT_MONTH_ID))
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_COMMISSION_REPORT_loadCommissionReportMonth) {
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.REPORT_MONTH_ID, other.REPORT_MONTH_ID);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:d+HdOnCO/MGVJ3H1KL7g+/bA0tT+HDvhmJizVboWv75YCEZV");
        ...
        if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
            tableName_tDBOutput_1 = ("COMMISSION_REPORT_MONTH");
        } else {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RmM+n2xXBCUvMvm006Pu9I0ylLL0lGWBEMtKHytaJGaCX9Au+M12Mq8t");
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  `COMMISSION_REPORT_MONTH`.`REPORT_MONTH_ID`\nFROM `COMMISSION_REPORT_MONTH`";
		    ...
		    while (rs_tDBInput_1.next()) {
				...
				if(rs_tDBInput_1.getString(1) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.REPORT_MONTH_ID = rs_tDBInput_1.getTimestamp(1);
					} else {
 ...
 */
    ...
    public static void main(String[] args){
        final loadCommissionReportMonth loadCommissionReportMonthClass = new loadCommissionReportMonth();

        int exitCode = loadCommissionReportMonthClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = loadCommissionReportMonth.class.getClassLoader().getResourceAsStream("commission_report/loadcommissionreportmonth_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = loadCommissionReportMonth.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : loadCommissionReportMonth");
        }
