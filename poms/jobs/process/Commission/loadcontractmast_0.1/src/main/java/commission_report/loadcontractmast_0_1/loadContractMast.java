...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ITa0FQ8HivoNXs/ZSJ9VEnRq0SoW/vca5Lk2b/1wNV8RKoXq");
...
dbschemaForSearch_tDBOutput_1= dbschema_tDBOutput_1.toUpperCase();
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1 + "(CONTRACT_ID VARCHAR(20)   not null ,PARTNER_ID VARCHAR(10)   not null ,REF_CONTRACT VARCHAR(50)  ,PROJECT_NAME VARCHAR(255)  ,SERVICE_CATE VARCHAR(10)  ,SAA_REGION VARCHAR(20)  ,SAA_PROVINCE VARCHAR(100)  ,SAA_SALES_TEAM VARCHAR(20)  ,SAA_SALES_REP VARCHAR(20)  ,REF_SAA VARCHAR(50)  ,REF_DOC VARCHAR(30)  ,EFF_DATE DATE ,EXPR_DATE DATE ,COMMISSION_ID VARCHAR(45)  ,ADDR_SEQ SMALLINT ,CONTACT_SEQ SMALLINT ,AUTH_BY VARCHAR(20)  ,AUTH_DATE DATE ,STATUS VARCHAR(2)  ,REASON_CODE VARCHAR(3)  ,REASON_NOTE CLOB ,CREATE_BY VARCHAR(20)  ,CREATE_DATE DATE ,LAST_UPDATE_BY VARCHAR(20)  ,LAST_UPDATE_DATE DATE ,IS_SKIPPED_BY_FINANCE VARCHAR(10)  default 'NO' ,MY_COMMISSION_ID VARCHAR(45)  ,IS_PROTOTYPE NUMBER(4,0)  default '0' ,primary key(CONTRACT_ID))");
                                    }
                                }
                ...
                String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1 + " (CONTRACT_ID,PARTNER_ID,REF_CONTRACT,PROJECT_NAME,SERVICE_CATE,SAA_REGION,SAA_PROVINCE,SAA_SALES_TEAM,SAA_SALES_REP,REF_SAA,REF_DOC,EFF_DATE,EXPR_DATE,COMMISSION_ID,ADDR_SEQ,CONTACT_SEQ,AUTH_BY,AUTH_DATE,STATUS,REASON_CODE,REASON_NOTE,CREATE_BY,CREATE_DATE,LAST_UPDATE_BY,LAST_UPDATE_DATE,IS_SKIPPED_BY_FINANCE,MY_COMMISSION_ID,IS_PROTOTYPE) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";    
                java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
                resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
                String update_tDBOutput_1 = "UPDATE " + tableName_tDBOutput_1 + " SET PARTNER_ID = ?,REF_CONTRACT = ?,PROJECT_NAME = ?,SERVICE_CATE = ?,SAA_REGION = ?,SAA_PROVINCE = ?,SAA_SALES_TEAM = ?,SAA_SALES_REP = ?,REF_SAA = ?,REF_DOC = ?,EFF_DATE = ?,EXPR_DATE = ?,COMMISSION_ID = ?,ADDR_SEQ = ?,CONTACT_SEQ = ?,AUTH_BY = ?,AUTH_DATE = ?,STATUS = ?,REASON_CODE = ?,REASON_NOTE = ?,CREATE_BY = ?,CREATE_DATE = ?,LAST_UPDATE_BY = ?,LAST_UPDATE_DATE = ?,IS_SKIPPED_BY_FINANCE = ?,MY_COMMISSION_ID = ?,IS_PROTOTYPE = ? WHERE CONTRACT_ID = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5hP6ENPlVLrYmZr4ywcqDhJ0v0JM9l306hlOoLaeBFA05rZCQ1Ep6fWV");
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  `CONTRACT_MAST`.`CONTRACT_ID`, \n  `CONTRACT_MAST`.`PARTNER_ID`, \n  `CONTRACT_MAST`.`REF_CONTRACT`, \n  `CONTRA"
+"CT_MAST`.`PROJECT_NAME`, \n  `CONTRACT_MAST`.`SERVICE_CATE`, \n  `CONTRACT_MAST`.`SAA_REGION`, \n  `CONTRACT_MAST`.`SAA_PRO"
...
+"E`\nFROM `CONTRACT_MAST`";
        	...
        	row1.PARTNER_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.REF_CONTRACT = null;
							} else {
	                         		
        	row1.REF_CONTRACT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.PROJECT_NAME = null;
							} else {
	                         		
        	row1.PROJECT_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.SERVICE_CATE = null;
							} else {
	                         		
        	row1.SERVICE_CATE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
        	...
        	row1.REF_SAA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.REF_DOC = null;
							} else {
	                         		
        	row1.REF_DOC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
				...
				if(rs_tDBInput_1.getString(12) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.EFF_DATE = rs_tDBInput_1.getTimestamp(12);
					} else {
				...
				if(rs_tDBInput_1.getString(13) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.EXPR_DATE = rs_tDBInput_1.getTimestamp(13);
					} else {
        	...
        	row1.COMMISSION_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.ADDR_SEQ = null;
							} else {
		                          
            row1.ADDR_SEQ = rs_tDBInput_1.getShort(15);
            ...
            row1.CONTACT_SEQ = rs_tDBInput_1.getShort(16);
            if(rs_tDBInput_1.wasNull()){
                    row1.CONTACT_SEQ = null;
            }
		                    }
        	...
        	row1.AUTH_BY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, false);
		                    }
				...
				if(rs_tDBInput_1.getString(18) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.AUTH_DATE = rs_tDBInput_1.getTimestamp(18);
					} else {
        	...
        	row1.STATUS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row1.REASON_CODE = null;
							} else {
	                         		
        	row1.REASON_CODE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.REASON_NOTE = null;
							} else {
	                         		
        	row1.REASON_NOTE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.CREATE_BY = null;
							} else {
	                         		
        	row1.CREATE_BY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
		                    }
				...
				if(rs_tDBInput_1.getString(23) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.CREATE_DATE = rs_tDBInput_1.getTimestamp(23);
					} else {
        	...
        	row1.LAST_UPDATE_BY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
				...
				if(rs_tDBInput_1.getString(25) != null) {
					String dateString_tDBInput_1 = rs_tDBInput_1.getString(25);
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.LAST_UPDATE_DATE = rs_tDBInput_1.getTimestamp(25);
					} else {
        	...
        	row1.IS_SKIPPED_BY_FINANCE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 26, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 27) {
								row1.MY_COMMISSION_ID = null;
							} else {
	                         		
        	row1.MY_COMMISSION_ID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 27, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 28) {
								row1.IS_PROTOTYPE = null;
							} else {
		                          
            row1.IS_PROTOTYPE = rs_tDBInput_1.getByte(28);
            if(rs_tDBInput_1.wasNull()){
                    row1.IS_PROTOTYPE = null;
            }
		                    }
...
} else {pstmt_tDBOutput_1.setString(1, row1.CONTRACT_ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(1, row1.PARTNER_ID);
}

                        if(row1.REF_CONTRACT == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, row1.REF_CONTRACT);
}

                        if(row1.PROJECT_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, row1.PROJECT_NAME);
}

                        if(row1.SERVICE_CATE == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, row1.SERVICE_CATE);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(9, row1.REF_SAA);
}

                        if(row1.REF_DOC == null) {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10, row1.REF_DOC);
}

                        if(row1.EFF_DATE != null) {
pstmtUpdate_tDBOutput_1.setObject(11, new java.sql.Timestamp(row1.EFF_DATE.getTime()),java.sql.Types.DATE);
} else {
pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.DATE);
}

                        if(row1.EXPR_DATE != null) {
pstmtUpdate_tDBOutput_1.setObject(12, new java.sql.Timestamp(row1.EXPR_DATE.getTime()),java.sql.Types.DATE);
} else {
...
} else {pstmtUpdate_tDBOutput_1.setString(13, row1.COMMISSION_ID);
}

                        if(row1.ADDR_SEQ == null) {
pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setShort(14, row1.ADDR_SEQ);
}

                        if(row1.CONTACT_SEQ == null) {
pstmtUpdate_tDBOutput_1.setNull(15, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setShort(15, row1.CONTACT_SEQ);
}

                        if(row1.AUTH_BY == null) {
pstmtUpdate_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(16, row1.AUTH_BY);
}

                        if(row1.AUTH_DATE != null) {
pstmtUpdate_tDBOutput_1.setObject(17, new java.sql.Timestamp(row1.AUTH_DATE.getTime()),java.sql.Types.DATE);
} else {
pstmtUpdate_tDBOutput_1.setNull(17, java.sql.Types.DATE);
}

                        if(row1.STATUS == null) {
pstmtUpdate_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(18, row1.STATUS);
}

                        if(row1.REASON_CODE == null) {
pstmtUpdate_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(19, row1.REASON_CODE);
}

                        if(row1.REASON_NOTE == null) {
pstmtUpdate_tDBOutput_1.setNull(20, java.sql.Types.CLOB);
} else {pstmtUpdate_tDBOutput_1.setCharacterStream(20, new java.io.StringReader(row1.REASON_NOTE), row1.REASON_NOTE.length());
}

                        if(row1.CREATE_BY == null) {
pstmtUpdate_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(21, row1.CREATE_BY);
}

                        if(row1.CREATE_DATE != null) {
pstmtUpdate_tDBOutput_1.setObject(22, new java.sql.Timestamp(row1.CREATE_DATE.getTime()),java.sql.Types.DATE);
} else {
...
} else {pstmtUpdate_tDBOutput_1.setString(23, row1.LAST_UPDATE_BY);
}

                        if(row1.LAST_UPDATE_DATE != null) {
pstmtUpdate_tDBOutput_1.setObject(24, new java.sql.Timestamp(row1.LAST_UPDATE_DATE.getTime()),java.sql.Types.DATE);
} else {
pstmtUpdate_tDBOutput_1.setNull(24, java.sql.Types.DATE);
}

                        if(row1.IS_SKIPPED_BY_FINANCE == null) {
pstmtUpdate_tDBOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(25, row1.IS_SKIPPED_BY_FINANCE);
}

                        if(row1.MY_COMMISSION_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(26, row1.MY_COMMISSION_ID);
}

                        if(row1.IS_PROTOTYPE == null) {
pstmtUpdate_tDBOutput_1.setNull(27, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setByte(27, row1.IS_PROTOTYPE);
}

                        if(row1.CONTRACT_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(28 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(28 + count_tDBOutput_1, row1.CONTRACT_ID);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row1.CONTRACT_ID);
}

                        if(row1.PARTNER_ID == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, row1.PARTNER_ID);
}

                        if(row1.REF_CONTRACT == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, row1.REF_CONTRACT);
}

                        if(row1.PROJECT_NAME == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, row1.PROJECT_NAME);
}

                        if(row1.SERVICE_CATE == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, row1.SERVICE_CATE);
}
...
} else {pstmtInsert_tDBOutput_1.setString(10, row1.REF_SAA);
}

                        if(row1.REF_DOC == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(11, row1.REF_DOC);
}

                        if(row1.EFF_DATE != null) {
pstmtInsert_tDBOutput_1.setObject(12, new java.sql.Timestamp(row1.EFF_DATE.getTime()),java.sql.Types.DATE);
} else {
pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.DATE);
}

                        if(row1.EXPR_DATE != null) {
pstmtInsert_tDBOutput_1.setObject(13, new java.sql.Timestamp(row1.EXPR_DATE.getTime()),java.sql.Types.DATE);
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(14, row1.COMMISSION_ID);
}

                        if(row1.ADDR_SEQ == null) {
pstmtInsert_tDBOutput_1.setNull(15, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setShort(15, row1.ADDR_SEQ);
}

                        if(row1.CONTACT_SEQ == null) {
pstmtInsert_tDBOutput_1.setNull(16, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setShort(16, row1.CONTACT_SEQ);
}

                        if(row1.AUTH_BY == null) {
pstmtInsert_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(17, row1.AUTH_BY);
}

                        if(row1.AUTH_DATE != null) {
pstmtInsert_tDBOutput_1.setObject(18, new java.sql.Timestamp(row1.AUTH_DATE.getTime()),java.sql.Types.DATE);
} else {
pstmtInsert_tDBOutput_1.setNull(18, java.sql.Types.DATE);
}

                        if(row1.STATUS == null) {
pstmtInsert_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(19, row1.STATUS);
}

                        if(row1.REASON_CODE == null) {
pstmtInsert_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(20, row1.REASON_CODE);
}

                        if(row1.REASON_NOTE == null) {
pstmtInsert_tDBOutput_1.setNull(21, java.sql.Types.CLOB);
} else {pstmtInsert_tDBOutput_1.setCharacterStream(21, new java.io.StringReader(row1.REASON_NOTE), row1.REASON_NOTE.length());
}

                        if(row1.CREATE_BY == null) {
pstmtInsert_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(22, row1.CREATE_BY);
}

                        if(row1.CREATE_DATE != null) {
pstmtInsert_tDBOutput_1.setObject(23, new java.sql.Timestamp(row1.CREATE_DATE.getTime()),java.sql.Types.DATE);
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(24, row1.LAST_UPDATE_BY);
}

                        if(row1.LAST_UPDATE_DATE != null) {
pstmtInsert_tDBOutput_1.setObject(25, new java.sql.Timestamp(row1.LAST_UPDATE_DATE.getTime()),java.sql.Types.DATE);
} else {
pstmtInsert_tDBOutput_1.setNull(25, java.sql.Types.DATE);
}

                        if(row1.IS_SKIPPED_BY_FINANCE == null) {
pstmtInsert_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(26, row1.IS_SKIPPED_BY_FINANCE);
}

                        if(row1.MY_COMMISSION_ID == null) {
pstmtInsert_tDBOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(27, row1.MY_COMMISSION_ID);
}

                        if(row1.IS_PROTOTYPE == null) {
pstmtInsert_tDBOutput_1.setNull(28, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setByte(28, row1.IS_PROTOTYPE);
}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = loadContractMast.class.getClassLoader().getResourceAsStream("commission_report/loadcontractmast_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = loadContractMast.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : loadContractMast");
        }
...
/************************************************************************************************
 *     76526 characters generated by Talend Open Studio for Data Integration 
