...
public class loadCommissionReport implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public String getORACLE_STATUS() {
			return this.ORACLE_STATUS;
		}

		public Integer ORACLE_REPORT_ID;

		public Integer getORACLE_REPORT_ID() {
			return this.ORACLE_REPORT_ID;
		}
		...
		public void copyDataTo(row1Struct other) {
			...
			other.ORACLE_STATUS = this.ORACLE_STATUS;
			other.ORACLE_REPORT_ID = this.ORACLE_REPORT_ID;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_COMMISSION_REPORT_loadCommissionReport) {
				...
				try {
					...
					this.ORACLE_STATUS = readString(dis);

					this.ORACLE_REPORT_ID = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.ORACLE_STATUS, dos);

				// Integer

				writeInteger(this.ORACLE_REPORT_ID, dos);
		...
		public String toString() {
			...
			sb.append(",ORACLE_STATUS=" + ORACLE_STATUS);
			sb.append(",ORACLE_REPORT_ID=" + String.valueOf(ORACLE_REPORT_ID));
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:4kHLR4SoF3S+RH+OKkRyhI113kv34s3pw+2xuC8U1J8wU5Mk");
				...
				String update_tDBOutput_1 = "UPDATE " + tableName_tDBOutput_1
						+ " SET REPORT_MONTH_ID = ?,SAA_CODE = ?,CA_CODE = ?,REPORT_TYPE = ?,CALCULATED_COMMISSION_AMOUNT = ?,APPROVED_COMMISSION_AMOUNT = ?,STATUS = ?,REMARK = ?,USER_STATUS = ?,USER_REMARK = ?,REVISION = ?,AS_OF_DATE = ?,CREATE_DATE = ?,UPDATE_DATE = ?,FINANCE_USER_APPROVE = ?,FINANCE_APPROVE_DATE = ?,SALE_USER_APPROVE = ?,SALE_APPROVE_DATE = ?,SALE_SAP_CODE = ?,ORG_CODE = ?,SERVICE_AMOUNT = ?,REPORT_VALUE = ?,ORACLE_STATUS = ?,ORACLE_REPORT_ID = ? WHERE REPORT_ID = ?";
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:cfCKkBba+Up5wk61kXoaZtBUWUt3jMv8DUlZPFPiw4cXAotSUWJ1m9oI");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 24) {
							row1.ORACLE_STATUS = null;
						} else {

							row1.ORACLE_STATUS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
						}
						if (colQtyInRs_tDBInput_1 < 25) {
							row1.ORACLE_REPORT_ID = null;
						} else {

							row1.ORACLE_REPORT_ID = rs_tDBInput_1.getInt(25);
							if (rs_tDBInput_1.wasNull()) {
								row1.ORACLE_REPORT_ID = null;
							}
						}
						...
						if (checkCount_tDBOutput_1 > 0) {
							if (row1.REPORT_MONTH_ID != null) {
								pstmtUpdate_tDBOutput_1.setObject(1,
										new java.sql.Timestamp(row1.REPORT_MONTH_ID.getTime()), java.sql.Types.DATE);
							} else {
							...
							if (row1.CA_CODE == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(3, row1.CA_CODE);
							}

							if (row1.REPORT_TYPE == null) {
								pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(4, row1.REPORT_TYPE);
							}
							...
							if (row1.STATUS == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(7, row1.STATUS);
							}

							if (row1.REMARK == null) {
								pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.CLOB);
							} else {
								pstmtUpdate_tDBOutput_1.setCharacterStream(8, new java.io.StringReader(row1.REMARK),
										row1.REMARK.length());
							}
							...
							if (row1.USER_STATUS == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(9, row1.USER_STATUS);
							}

							if (row1.USER_REMARK == null) {
								pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.CLOB);
							} else {
								pstmtUpdate_tDBOutput_1.setCharacterStream(10,
										new java.io.StringReader(row1.USER_REMARK), row1.USER_REMARK.length());
							}

							pstmtUpdate_tDBOutput_1.setShort(11, row1.REVISION);

							if (row1.AS_OF_DATE != null) {
								pstmtUpdate_tDBOutput_1.setObject(12, new java.sql.Timestamp(row1.AS_OF_DATE.getTime()),
										java.sql.Types.DATE);
							} else {
							...
							if (row1.UPDATE_DATE != null) {
								pstmtUpdate_tDBOutput_1.setObject(14,
							...
							if (row1.FINANCE_USER_APPROVE == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(15, row1.FINANCE_USER_APPROVE);
							}

							if (row1.FINANCE_APPROVE_DATE != null) {
								pstmtUpdate_tDBOutput_1.setObject(16,
										new java.sql.Timestamp(row1.FINANCE_APPROVE_DATE.getTime()),
										java.sql.Types.DATE);
							} else {
							...
							if (row1.SALE_USER_APPROVE == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(17, row1.SALE_USER_APPROVE);
							}

							if (row1.SALE_APPROVE_DATE != null) {
								pstmtUpdate_tDBOutput_1.setObject(18,
										new java.sql.Timestamp(row1.SALE_APPROVE_DATE.getTime()), java.sql.Types.DATE);
							} else {
							...
							if (row1.SALE_SAP_CODE == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(19, row1.SALE_SAP_CODE);
							}

							if (row1.ORG_CODE == null) {
								pstmtUpdate_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(20, row1.ORG_CODE);
							}

							if (row1.SERVICE_AMOUNT == null) {
								pstmtUpdate_tDBOutput_1.setNull(21, java.sql.Types.INTEGER);
							} else {
								pstmtUpdate_tDBOutput_1.setLong(21, row1.SERVICE_AMOUNT);
							}

							pstmtUpdate_tDBOutput_1.setBigDecimal(22, row1.REPORT_VALUE);

							if (row1.ORACLE_STATUS == null) {
								pstmtUpdate_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(23, row1.ORACLE_STATUS);
							}

							if (row1.ORACLE_REPORT_ID == null) {
								pstmtUpdate_tDBOutput_1.setNull(24, java.sql.Types.INTEGER);
							} else {
								pstmtUpdate_tDBOutput_1.setInt(24, row1.ORACLE_REPORT_ID);
							}

							pstmtUpdate_tDBOutput_1.setInt(25 + count_tDBOutput_1, row1.REPORT_ID);
							...
							if (row1.CA_CODE == null) {
								...
								pstmtInsert_tDBOutput_1.setString(4, row1.CA_CODE);
							}

							if (row1.REPORT_TYPE == null) {
								pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmtInsert_tDBOutput_1.setString(5, row1.REPORT_TYPE);
							}
							...
							if (row1.STATUS == null) {
								...
								pstmtInsert_tDBOutput_1.setString(8, row1.STATUS);
							}

							if (row1.REMARK == null) {
								pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.CLOB);
							} else {
								pstmtInsert_tDBOutput_1.setCharacterStream(9, new java.io.StringReader(row1.REMARK),
										row1.REMARK.length());
							}
							...
							if (row1.USER_STATUS == null) {
								...
								pstmtInsert_tDBOutput_1.setString(10, row1.USER_STATUS);
							}

							if (row1.USER_REMARK == null) {
								pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.CLOB);
							} else {
								pstmtInsert_tDBOutput_1.setCharacterStream(11,
										new java.io.StringReader(row1.USER_REMARK), row1.USER_REMARK.length());
							}
							...
							if (row1.AS_OF_DATE != null) {
								pstmtInsert_tDBOutput_1.setObject(13, new java.sql.Timestamp(row1.AS_OF_DATE.getTime()),
										java.sql.Types.DATE);
							} else {
							...
							if (row1.UPDATE_DATE != null) {
								pstmtInsert_tDBOutput_1.setObject(15,
										new java.sql.Timestamp(row1.UPDATE_DATE.getTime()), java.sql.Types.DATE);
							} else {
							...
							if (row1.FINANCE_USER_APPROVE == null) {
								...
								pstmtInsert_tDBOutput_1.setString(16, row1.FINANCE_USER_APPROVE);
							}
							...
							if (row1.SALE_USER_APPROVE == null) {
								...
								pstmtInsert_tDBOutput_1.setString(18, row1.SALE_USER_APPROVE);
							}
							...
							if (row1.SALE_SAP_CODE == null) {
								...
								pstmtInsert_tDBOutput_1.setString(20, row1.SALE_SAP_CODE);
							}

							if (row1.ORG_CODE == null) {
								pstmtInsert_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
							} else {
								pstmtInsert_tDBOutput_1.setString(21, row1.ORG_CODE);
							}

							if (row1.SERVICE_AMOUNT == null) {
								pstmtInsert_tDBOutput_1.setNull(22, java.sql.Types.INTEGER);
							} else {
								pstmtInsert_tDBOutput_1.setLong(22, row1.SERVICE_AMOUNT);
							}
							...
							if (row1.ORACLE_STATUS == null) {
								...
								pstmtInsert_tDBOutput_1.setString(24, row1.ORACLE_STATUS);
							}

							if (row1.ORACLE_REPORT_ID == null) {
								pstmtInsert_tDBOutput_1.setNull(25, java.sql.Types.INTEGER);
							} else {
								pstmtInsert_tDBOutput_1.setInt(25, row1.ORACLE_REPORT_ID);
							}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = loadCommissionReport.class.getClassLoader().getResourceAsStream(
					"commission_report/loadcommissionreport_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = loadCommissionReport.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : loadCommissionReport");
		}
...
/************************************************************************************************
 * 74272 characters generated by Talend Open Studio for Data Integration on the
 * April 4, 2021 6:35:03 PM ICT
 ************************************************************************************************/